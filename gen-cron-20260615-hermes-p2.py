#!/usr/bin/env python3
"""Generate 5 new Dutch consumer comparison articles for Dutch AI Tools — June 15, 2026.
Expands thin categories: persoonlijk (4→7) and huis-tuin (2→4), plus 1 new category.
Uses the same Gemini API + delimiter approach as gen-cron-20260615-hermes.py."""
...
ARTICLES = [
    # Missing from June 15 cron (reisverzekering + zorgverzekering)
    ("beste-reisverzekering-2026-anwb-allianz-europeesche-ohra-unive",
     "de beste doorlopende reisverzekeringen: dekking, werelddekking, annulering en medische kosten",
     "persoonlijk",
     "Nederlandse reizigers die een doorlopende reisverzekering zoeken",
     "ANWB, Allianz Global Assistance, Europeesche, OHRA, Univé, Centraal Beheer, FBTO"),

    ("beste-zorgverzekering-2026-zilveren-kruis-cz-vgz-menzis-dsw",
     "de beste zorgverzekeringen: basisverzekering, aanvullende pakketten en tandartsverzekering vergeleken",
     "persoonlijk",
     "Nederlanders die hun zorgverzekering willen vergelijken voor 2026",
     "Zilveren Kruis, CZ, VGZ, Menzis, DSW, FBTO Zorg, Ditzo"),

    # New: expand huis-tuin
    ("beste-energieleveranciers-2026-vergelijken-essent-vattenfall-engie-greenchoice",
     "de beste energieleveranciers: groene stroom, gas, dynamische contracten en vaste tarieven vergeleken",
     "huis-tuin",
     "Nederlandse huishoudens die willen overstappen van energieleverancier",
     "Essent, Vattenfall, Engie, Greenchoice, Budget Energie, Vandebron, Pure Energie"),

    # New: expand persoonlijk
    ("beste-beleggingsapps-2026-degiro-etoro-bux-trading212-saxo",
     "de beste beleggingsapps voor beginners en gevorderden: aandelen, ETF's, crypto en kosten vergeleken",
     "persoonlijk",
     "Nederlanders die willen beginnen met beleggen of overstappen van broker",
     "DEGIRO, eToro, BUX, Trading 212, Saxo Bank, Meesman, Brand New Day"),

    # New: fitness/gezondheid category
    ("beste-fitness-apps-2026-fitbit-strava-myfitnesspal-lifesum-virtuagym",
     "de beste fitness apps en gezondheidsapps: workouts, voeding, slaap en activiteit tracken",
     "persoonlijk",
     "Nederlanders die fitter willen worden met een app als coach",
     "Fitbit Premium, Strava, MyFitnessPal, Lifesum, Virtuagym, Fitbod, Freeletics"),
]
