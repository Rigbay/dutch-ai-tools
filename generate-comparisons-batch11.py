...
ARTICLES = [
    {
        ...
        "readingTime": "9 min",
        "tools": [
            {"name": "DeepL", "verdict": "Beste AI-vertaaltool voor Nederlands en Europese talen", "priceRange": "EUR 0-25/mnd", "bestFor": "Professionele vertalingen", "rating": 4.7, "affiliateLink": "https://affiliate.notion.so/?via=aitoolsnl"},
            {"name": "Google Translate", "verdict": "Meeste talen (133+) en beste integratie met Google-ecosysteem", "priceRange": "EUR 0 (gratis)", "bestFor": "Snelle vertalingen", "rating": 4.3, "affiliateLink": "https://affiliate.notion.so/?via=aitoolsnl"},
            {"name": "ChatGPT", "verdict": "Meest flexibel — vertaalt met context, stijl en nuance, maar minder consistent", "priceRange": "EUR 0-25/mnd", "bestFor": "Creatieve & contextrijke teksten", "rating": 4.4, "affiliateLink": "https://affiliate.notion.so/?via=aitoolsnl"},
        ],
...
Focus op de Nederlandse/Europese context. DeepL is Duits, dus EU-dataverwerking. Prijzen in EUR. Schrijf in vloeiend, nuchter Nederlands.""",
    },
    {
        ...
        "readingTime": "8 min",
        "tools": [
            {"name": "Fireflies.ai", "verdict": "Meest complete — transcriptie, zoeken, actiepunten, CRM-integraties", "priceRange": "EUR 0-19/mnd", "bestFor": "Verkoopteams & power users", "rating": 4.6, "affiliateLink": "https://affiliate.notion.so/?via=aitoolsnl"},
            {"name": "Otter.ai", "verdict": "Beste realtime transcripties en samenwerking, sterk in onderwijs", "priceRange": "EUR 0-17/mnd", "bestFor": "Teams & onderwijs", "rating": 4.4, "affiliateLink": "https://affiliate.notion.so/?via=aitoolsnl"},
            {"name": "Fathom", "verdict": "Meest gebruiksvriendelijk — automatische samenvattingen zonder bot in call", "priceRange": "EUR 0-29/mnd", "bestFor": "Individuen & kleine teams", "rating": 4.5, "affiliateLink": "https://affiliate.notion.so/?via=aitoolsnl"},
        ],
...
Focus op Nederlands gebruik. Prijzen in EUR. Schrijf vloeiend Nederlands.""",
    },
    {
        ...
        "readingTime": "8 min",
        "tools": [
            {"name": "Gamma", "verdict": "Meest veelzijdig — presentaties, docs en websites in één tool", "priceRange": "EUR 0-10/mnd", "bestFor": "Veelzijdige content creators", "rating": 4.6, "affiliateLink": "https://affiliate.notion.so/?via=aitoolsnl"},
            {"name": "Beautiful.ai", "verdict": "Design-automatisering op topniveau — consistent mooie slides", "priceRange": "EUR 12-40/mnd", "bestFor": "Professionals die design niet willen doen", "rating": 4.4, "affiliateLink": "https://affiliate.notion.so/?via=aitoolsnl"},
            {"name": "Tome", "verdict": "Beste storytelling — genereert complete verhaallijnen met AI", "priceRange": "EUR 0-16/mnd", "bestFor": "Storytelling & pitches", "rating": 4.3, "affiliateLink": "https://affiliate.notion.so/?via=aitoolsnl"},
        ],
...
Prijzen in EUR. Schrijf nuchter en praktisch Nederlands.""",
    },
    {
        ...
        "readingTime": "8 min",
        "tools": [
            {"name": "Descript", "verdict": "Revolutionair — bewerk audio alsof het tekst is, met studiokwaliteit AI-stem", "priceRange": "EUR 0-24/mnd", "bestFor": "All-in-one podcast & video", "rating": 4.7, "affiliateLink": "https://affiliate.notion.so/?via=aitoolsnl"},
            {"name": "Podcastle", "verdict": "Beste prijs-kwaliteit voor audio-only podcasters", "priceRange": "EUR 0-12/mnd", "bestFor": "Budget podcasters", "rating": 4.3, "affiliateLink": "https://affiliate.notion.so/?via=aitoolsnl"},
            {"name": "Alitu", "verdict": "Gebouwd voor solo podcasters — geautomatiseerde workflow van opname tot publicatie", "priceRange": "EUR 32/mnd", "bestFor": "Automatisering", "rating": 4.2, "affiliateLink": "https://affiliate.notion.so/?via=aitoolsnl"},
        ],
...
Focus op Nederlands gebruik. Prijzen in EUR. Schrijf in vloeiend, toegankelijk Nederlands.""",
    },
    {
        ...
        "readingTime": "9 min",
        "tools": [
            {"name": "SurferSEO", "verdict": "Beste allround SEO-content tool — content editor met realtime NL-SERP-analyse", "priceRange": "EUR 59-199/mnd", "bestFor": "Content SEO allround", "rating": 4.6, "affiliateLink": "https://affiliate.notion.so/?via=aitoolsnl"},
            {"name": "Clearscope", "verdict": "Premium AI-contentoptimalisatie — Google's eigen aanpak van relevante content", "priceRange": "EUR 150-500/mnd", "bestFor": "Enterprise SEO-teams", "rating": 4.4, "affiliateLink": "https://affiliate.notion.so/?via=aitoolsnl"},
            {"name": "MarketMuse", "verdict": "AI-contentstrategie op schaal — automatiseert content gap analyse en planning", "priceRange": "EUR 79-500/mnd", "bestFor": "Contentstrategie op schaal", "rating": 4.3, "affiliateLink": "https://affiliate.notion.so/?via=aitoolsnl"},
        ],
