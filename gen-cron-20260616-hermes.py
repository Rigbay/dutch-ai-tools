#!/usr/bin/env python3
"""Generate 5 Dutch consumer comparison articles — June 16, 2026 cron. V4: delimiter approach."""
...
ARTICLES = [
    ("maaltijdboxen-vergelijken-2026-hellofresh-marley-spoon-factor-green-chef", "de beste maaltijdboxen en maaltijdpakketten voor Nederlandse huishoudens: gemak, variatie en prijs per portie", "persoonlijk", "Nederlanders die een maaltijdbox overwegen voor gemak, variatie of gezondere maaltijden", "HelloFresh, Marley Spoon, Factor (voorheen Factor75), Green Chef, Ekomenu, Dinnerly, Foodbag"),
    ("luisterboeken-apps-vergelijken-2026-audible-storytel-kobo-nextory", "de beste luisterboeken apps en abonnementen: onbeperkt luisteren, credits en bibliotheek vergeleken", "persoonlijk", "Nederlandse luisteraars die een luisterboek-abonnement zoeken", "Audible, Storytel, Kobo Plus Luisteren, Nextory, BookBeat, Everand (Scribd), LuisterBieb"),
    ("thuisbeveiliging-vergelijken-2026-ring-eufy-ajax-verisure", "de beste thuisbeveiliging en slimme deurbellen: camerasystemen, alarmsystemen en abonnementen vergeleken", "huis-tuin", "Nederlandse huiseigenaren die hun woning willen beveiligen met camera's, alarm of deurbel", "Ring, Eufy Security, Ajax Systems, Verisure, SimpliSafe, Arlo, Google Nest"),
