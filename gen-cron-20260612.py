#!/usr/bin/env python3
"""Generate 5 Dutch consumer comparison articles — June 12, 2026 cron. High-volume underserved niches."""
...
def build_article(defn, body_text):
    ...
    for tool in defn["tools"]:
        ...
        # If no program exists, keep the plain URL
...
TOPICS = [
    {
        ...
        "description": "Energiecontract afsluiten in 2026? Vergelijk vaste, dynamische en variabele contracten van Essent, Vattenfall, Eneco, Greenchoice, Budget Energie, ANWB Energie en Zonneplan op prijs, zekerheid en duurzaamheid.",
        "category": "huis-tuin",
        "priceRange": "EUR 80-250 per maand (gemiddeld huishouden)",
        "prompt": """Schrijf een Nederlands artikel van 1200-1500 woorden over energiecontracten vergelijken in 2026. Behandel precies 7 aanbieders: Essent, Vattenfall, Eneco, Greenchoice, Budget Energie, ANWB Energie, Zonneplan.

Structuur:
- Introductie: energiemarkt 2026 — gasprijs volatiel, salderingsregeling afbouw, dynamische contracten populair (1,5+ miljoen huishoudens), terugleverkosten bij zonnepanelen, vast contract weer interessant nu prijzen dalen
- Per aanbieder een ## kop: type contracten (vast/dynamisch/variabel), prijsindicatie (stroom + gas per m3/kWh), groene stroom %, klantenservice-rating, app/online omgeving, plus- en minpunten, verdict
- Markdown vergelijkingstabel: aanbieder, vast contract prijs, dynamisch beschikbaar, groene stroom %, terugleverkosten, klantenservice-score, app-rating, score (1-5)
- Conclusie: voor zonnepanelen-bezitters, prijsbewuste huishoudens, zekerheidzoekers, groene stroom fans, dynamisch durfals
- 3 FAQ's

Nederlandse context: ACM toezicht, modelcontract als vangnet, opzegvergoeding bij vast contract (max €125 bij >1 jaar resterend), dynamische prijzen per uur (EPEX-beurs), Zonneplan en ANWB Energie zijn nieuwkomers zonder eigen opwek. Greenchoice is groenste. Budget Energie goedkoopste. Vattenfall en Eneco grootste met eigen centrales. Vloeiend en toegankelijk Nederlands.""",
        "tools": [
            {"name": "Essent", "verdict": "Grootste en betrouwbaarste — 100% groene stroom uit NL, vast 1-3 jaar, uitgebreide app, onderdeel E.ON", "priceRange": "€0,28-0,35/kWh stroom, €1,20-1,45/m3 gas", "bestFor": "Betrouwbaarheid & Service", "rating": 4.5, "affiliateLink": "https://essent.nl/"},
            {"name": "Vattenfall", "verdict": "Beste allround — eigen centrales, vast en variabel, CO2-gecompenseerd gas, goede app", "priceRange": "€0,27-0,34/kWh stroom, €1,15-1,40/m3 gas", "bestFor": "Allround & Zekerheid", "rating": 4.4, "affiliateLink": "https://vattenfall.nl/"},
            {"name": "Eneco", "verdict": "Beste voor dynamisch — eigen windparken, HollandscheWind, dynamisch contract met realtime app, innovatief", "priceRange": "€0,25-0,38/kWh (dynamisch), €1,10-1,50/m3 gas", "bestFor": "Dynamisch & Innovatief", "rating": 4.3, "affiliateLink": "https://eneco.nl/"},
            {"name": "Greenchoice", "verdict": "Groenste keuze — 100% Nederlandse groene stroom, vast en variabel, geen gas uit Rusland, B Corp", "priceRange": "€0,29-0,36/kWh stroom, €1,25-1,50/m3 gas", "bestFor": "Duurzaamheid", "rating": 4.2, "affiliateLink": "https://greenchoice.nl/"},
            {"name": "Budget Energie", "verdict": "Goedkoopste — scherpste tarieven, vast 1-3 jaar, eenvoudig online, geen poespas", "priceRange": "€0,25-0,32/kWh stroom, €1,10-1,35/m3 gas", "bestFor": "Budgetbewust", "rating": 4.0, "affiliateLink": "https://budgetenergie.nl/"},
            {"name": "ANWB Energie", "verdict": "Beste voor ANWB-leden — ledenkorting, dynamisch en vast, 100% groen, koppeling met ANWB-app", "priceRange": "€0,26-0,34/kWh stroom, €1,15-1,40/m3 gas", "bestFor": "ANWB Leden", "rating": 4.1, "affiliateLink": "https://anwb.nl/energie"},
            {"name": "Zonneplan", "verdict": "Beste dynamisch met zonnepanelen — realtime sturing, laadt EV op goedkoopste uren, geen terugleverkosten bij slim sturen", "priceRange": "€0,22-0,40/kWh (dynamisch), €1,05-1,55/m3 gas", "bestFor": "Zonnepanelen + EV", "rating": 4.4, "affiliateLink": "https://zonneplan.nl/"},
        ],
    },
    {
